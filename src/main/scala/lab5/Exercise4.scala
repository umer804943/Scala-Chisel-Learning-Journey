...
/*
  I don't see any difference in both results wihh cloneType and without but I think
  cloneType needed in older versions of chisel when using TypeParameter it can be solve by generic param as private or by cloneType
*/